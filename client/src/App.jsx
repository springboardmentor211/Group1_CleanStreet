...
// Use your TrackCommunityIssues component
...
function App() {
  ...
  // Navigation logic inside the function
  ...
  if (mode === "community-reports") return <TrackCommunityIssues onNavigate={handleNavigate} />;
  if (mode === "login")
    return (
      <LoginPage
  ...
  if (mode === "otp")
    return <OtpPage onGoToReset={() => setMode("reset")} onBackToLogin={() => setMode("login")} />;
  if (mode === "reset") return <ResetPassword onBackToLogin={() => setMode("login")} />;
