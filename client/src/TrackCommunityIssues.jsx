...
export default function TrackCommunityIssues({ onNavigate }) {
      ...
      <div className="page-background">
        <div className="page-content">
          ...
          <div className="page-title-section">
            <h1 className="page-title">Track Community Issues</h1>
                ...
                <div key={c._id} className="community-report-card">
                  {c.image && (
                    <img 
                      src={c.image} 
                      alt={c.title}
                      className="community-report-image" 
                    />
                  )}
                  
                  <div className="community-report-content">
                    <div className="community-report-header">
                      <h3 className="community-report-title">{c.title}</h3>
                      <StatusBadge status={c.status} />
                    </div>
                    
                    <p className="community-report-description">{c.description}</p>
